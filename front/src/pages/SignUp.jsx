            ...
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-yellow-400 to-green-400">
                <div className="bg-white/90 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-[90%] max-w-md transition-transform hover:scale-[1.02]">
                    ...
                    <form onSubmit={handleSignUp} className="space-y-5">
                        <div className="flex">
                            ...
                            <div className="pr-2">
                                ...
                                <div className="flex items-center border rounded-xl px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-500">
                                    <input type="text" placeholder="Nom" value={name} onChange={(e)=>setName(e.target.value)} required className="w-full bg-transparent outline-none text-gray-800"/>
                                </div>
                            </div>
                            <div>
                                <label className="block text-gray-700 mb-2 font-medium ">Prenom</label>
                                <div className="flex items-center border rounded-xl px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-500">
                                    <input type="text" placeholder="Prenom" value={firstname} onChange={(e)=>setFirstname(e.target.value)} required className="w-full bg-transparent outline-none text-gray-800"/>
                                </div>
                            </div>
                        </div>
                        <div>
                        ...
                        <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-xl shadow-md transition-all">S'inscrire</button>
                    </form>
                    <Link to={"/"} className="flex justify-center items-center pt-4 font-semibold ">Se Connecter a mon compte</Link>
                </div>
            </div>
        </>
    )
